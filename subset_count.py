# -*- coding: utf-8 -*-
'''Count common items bought together

This module can be used to extract and count items commonly bought together.
The items are extracted from a transaction log and the item subsets, including
subset frequency, are exported to a textfile. In order to reduce the amount of
possible item combinations, it increases the subset size in an iterative way
and uses the output of an iteration to reduce the subsets of the next
iteration.
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Count subsets.')
    ...
    parser.add_argument('output_file', type=str, nargs='?',
                        help='outputfile (default: output.txt)',
                        default='output.txt')
